...
$username = $name = $email = $password = $cpassword = $active = $permission = $country = $pcode = $city = $address = "";
...
//--------------------------------Password Valid...
  ...
  if(empty($usernameErr) && empty($nameErr) && empty($emailErr) && empty($passwordErr) && empty($activeErr)) {
   
    var_dump($username, $name, $email, $active, $permission, $country, $pcode, $city, $address);
    echo "All field ok";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
  ...
  Upload your avatar  <input type="file" name="image" />
  <span class="error"> <?php echo $emailErr;?></span>
  <br><br>

  Active:
  <input type="radio" name="active" <?php if (isset($active) && $active=="yes") echo "checked";?> value="yes">Yes
  ...
  Postal code: <input type="text" name="pcode" value="">
  <br><br>
