...
<form class='form-group' method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
  ...
  E-mail: <input type="text" name="email" value=""  placeholder=<?php echo $emaildb;?>>
  ...
  Postal code: <input type="text" name="pcode" value="" placeholder=<?php echo $pcode;?>>
  <br><br>

  City: <input type="text" name="city" value="" placeholder=<?php echo $city;?>>
  <br><br>

  Address: <input type="text" name="address" value="" placeholder=<?php echo $address;?>>
  <br><br>
